<template>
	<div class="container tw-justify-center tw-text-5xl tw-text-black tw-my-10">
		<div class="tw-text-center tw-mt-10 tw-flex tw-flex-row tw-justify-center" v-if="error != null">
			{{ error }}
		</div>
		<div class="tw-text-center tw-text-4xl tw-flex tw-flex-row tw-justify-center tw-my-2">Please try again or choose a Pokéball</div>

		<div class="pokeballs tw-flex tw-flex-wrap tw-justify-center tw-gap-5 tw-my-5">
